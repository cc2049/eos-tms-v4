<!--
 * @Author: cc2049
 * @Date: 2024-04-28 13:15:23
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2024-04-28 13:15:25
 * @Description: 简介
-->
<template>
  <template v-for="(itemBtn,indexBtn) in topButton" :key="itemBtn.BILLNO">
    <el-button :plain="indexBtn!=0" @click="handelEvent(itemBtn)" size="Default" :type="itemBtn.COLOR" :disabled="getButtonStatus(itemBtn)" :title="itemBtn.BTNTITLE " v-if="setShowBtn(itemBtn) ">
      {{ itemBtn.VNAME }}
    </el-button>
