      ...
      <template v-if="!topNav">
        ...
        >
          <div
            :class="[
              'menu-title',
              dataMenu.NAME == item.NAME ? 'active-menu' : '',
            ]"
          >
      ...
      <div class="submenu-wrap">
        ...
        <div class="ali-case" :style="{ width: modalWidth + 'px' }">
          <el-scrollbar :height="modalHeight" >
            <div class="favorite">
              <div class="favorite-title ali-menu-title">快捷入口222</div>
            ...
            <div class="eos-menu" @click="closeParent">
              <div
...
if (systemConfig.value && systemConfig.value.baseUrl) {
  avatarUrl.value =  systemConfig.value.logo.includes('http')? systemConfig.value.logo: systemConfig.value.baseUrl + systemConfig.value.logo;
