...
export const TableConfig_Form = [
  ...
  { FIELD: "TERMINALTYPE", LABEL: "终端", WIDTH: "80", ALIGN: "center", CONTROLS: "slot", OTHER: JSON.stringify(TERMINALOptions), EDITTABLE: 0, DEFAULTVAL: "91111", ISREQUIRE: 1, ISSHOW: 1, COL: 8, ISSORT: 1 },
  { FIELD: "FUNCTYPE", LABEL: "功能", WIDTH: "80", ALIGN: "center", CONTROLS: "slot", OTHER: JSON.stringify(FUNCTIONTYPEOptions), EDITTABLE: 0, DEFAULTVAL: "91111", ISREQUIRE: 1, ISSHOW: 1, COL: 8, ISSORT: 1 },
  { FIELD: "LABELLINK", LABEL: "label超连接", WIDTH: "80", ALIGN: "left", CONTROLS: "ExTextBox",  EDITTABLE: 1, DEFAULTVAL: "", ISREQUIRE: 0, ISSHOW: 1, COL: 8 },
  ...
  { FIELD: "WIDTH", LABEL: "宽度", WIDTH: "80", ALIGN: "left", CONTROLS: "ExNumber", EDITTABLE: 1, MAXLENGHT: "9999", DEFAULTVAL: "", ISREQUIRE: 0, ISSHOW: 1, COL: 8 },
...
export const TableConfig_Qty = [
  ...
  { FIELD: "QUERYTYPE", LABEL: "查询类型", WIDTH: "150", ALIGN: "left", CONTROLS: "ExSelect", EDITTABLE: 1, OTHER: JSON.stringify(QUERYTYPE), DEFAULTVAL: "Like", ISSHOW: 1, COL: 8, ISREQUIRE: 0, },
  ...
  { FIELD: "BUSSTYPE", LABEL: "默认设置", WIDTH: "150", ALIGN: "left", CONTROLS: "ExSelect", EDITTABLE: 1, OTHER: JSON.stringify(BUSSTYPE), DEFAULTVAL: "0", ISSHOW: 1, COL: 8, ISREQUIRE: 0, },
  { FIELD: "LINKAGE", LABEL: "级联", WIDTH: "100", ALIGN: "left", CONTROLS: "ExTextBox", EDITTABLE: 1, DEFAULTVAL: "", ISSHOW: 1, COL: 8 },
...
export const TableConfig_Table = [
  ...
  { FIELD: "SORTCODE", LABEL: "排序", WIDTH: "100", ALIGN: "center", CONTROLS: "ExNumber", EDITTABLE: 1, DEFAULTVAL: "", ISSHOW: 1, COL: 8, ISSORT: 1, ISREQUIRE: 1, LINKAGE: "{\"POINT\":\"0\"}" },
  { FIELD: "TERMINALTYPE", LABEL: "终端", WIDTH: "80", ALIGN: "center", CONTROLS: "slot", OTHER: JSON.stringify(TERMINALOptions), EDITTABLE: 1, DEFAULTVAL: "91111", ISREQUIRE: 1, ISSHOW: 1, COL: 8, ISSORT: 1 },
...
export const FormConfig = [
  ...
  { FIELD: "LABELWIDTH", LABEL: "标题宽", COL: 8, CONTROLS: "ExTextBox", ISSHOW: "2", LINKAGE: "{\"ISSHOW\":\"Data.GROUPNO=='FM'\"}" },
  { FIELD: "FIELDWIDTH", LABEL: "输入框宽", COL: 8, CONTROLS: "ExTextBox", ISSHOW: "2", LINKAGE: "{\"ISSHOW\":\"Data.GROUPNO=='FM'\"}" },
  ...
  { FIELD: "ISRELATEID", LABEL: "携带参数", COL: 4, CONTROLS: "ExSwitch", ISSHOW: "1", DEFAULTVAL: "0",LABELDESC:"打开菜单时需要传递id和操作类型type" },
  { FIELD: "ISHIDE", LABEL: "菜单隐藏", COL: 8, CONTROLS: "ExSwitch", ISSHOW: "1", DEFAULTVAL: "0", },
